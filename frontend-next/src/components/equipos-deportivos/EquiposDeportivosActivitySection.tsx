...
interface EquiposDeportivosActivitySectionProps {
  showActivity: string[];
  priceLabel?: string; // Optional custom label for price
}

const EquiposDeportivosActivitySection: React.FC<EquiposDeportivosActivitySectionProps> = ({
  showActivity,
  priceLabel,
}) => {
...
export default EquiposDeportivosActivitySection;
