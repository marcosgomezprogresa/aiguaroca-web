...
interface EquiposDeportivosModalProps {
  closeModal: () => void;
  title: string;
}

const EquiposDeportivosModal: React.FC<EquiposDeportivosModalProps> = ({ closeModal, title }) => {
...
export default EquiposDeportivosModal;
