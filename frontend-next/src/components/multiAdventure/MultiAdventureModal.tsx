...
interface MultiAdventureModalProps {
  closeModal: () => void;
}
...
const MultiAdventureModal: React.FC<MultiAdventureModalProps> = ({
  closeModal,
}) => {
  ...
  const activityHandler = async (e: React.FormEvent) => {
    ...
    try {
      const data = {
        ...
        message: message,
        extraNote:
          "Nombre de la actividad: Dia Multiaventura, Selected Activities: " +
          activities.join(", ") +
...
export default MultiAdventureModal;
