...
interface MultiAdventureHeroProps {
  openModal: () => void;
  imgs: string[];
  ...
  packName: string;
  des: React.ReactNode;
  secondDes?: React.ReactNode;
  showSeeMore?: boolean;
}

const MultiAdventureHero: React.FC<MultiAdventureHeroProps> = ({
  openModal,
  imgs,
  breadCrumsPaths,
  heading,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 sr-reveal">
        <div className="col-span-2 space-y-8 text-lg lg:text-xl max-w-2xl">
          ...
          {showSeeMore && (
            <Button
              ...
              className={
                "bg-white shadow border border-neutral-100 text-brand-300 px-3 py-1.5"
              }
            >
        ...
        <div className="col-span-1 hidden lg:flex items-start justify-end">
          <div className="w-full max-w-md border border-neutral-200 p-10 shadow-lg rounded-2xl space-y-7">
            <Button
              className={
                "bg-neutral-200 text-neutral-950 text-xl 2xl:text-3xl w-full p-3 font-medium"
              }
            >
              ...
              <div className="space-y-7">
                ...
                >
                  <Button
                    ...
                    className={
                      "w-full text-neutral-950 bg-neutral-200 p-3 gap-2"
                    }
                  >
...
export default MultiAdventureHero;
